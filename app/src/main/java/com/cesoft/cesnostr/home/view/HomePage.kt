...
private fun HomePage_Preview() {
    val m1 = NostrMetadata(
        ...
        banner = "",
        lud06 = "",
        lud16 = "aaaaaa@aaa.com",
        nip05 = ""
    )
    val m2 = NostrMetadata(
        about = "Test 2",
        name = "Test NAme",
        displayName = "",
        website = "",
    ...
    val state = HomeState.Init(
        ...
        metadata = mapOf(
            "1e67de3754171071d3cf9b44b6e546bd94fd0a2ca3fb4dbbb1b054685c9116e4" to m1,
            "aac9cfd55415fb5a175f131238c37386f7c24a7e0fc9ddace56fac72edf06307" to m2,
        )
    )
//    val state = HomeState.Init(
//        events = listOf(
